...
MODEL_PATH = os.environ.get("MODEL_PATH", "/opt/llm/models/Meta-Llama-3-8B-Instruct")
DATASET_PATH = os.environ.get("DATASET_PATH", "/opt/llm/datasets/xlam-function-calling-60k")
OUTPUT_DIR = os.environ.get("OUTPUT_DIR", "/data/llm/output/llama-3-8b-function-calling-fsdp")
...
def main() -> None:
    ...
    # done with this part
    model = prepare_model_for_kbit_training(model, torch_dtype=torch.bfloat16)
    # --- END FIX ---
